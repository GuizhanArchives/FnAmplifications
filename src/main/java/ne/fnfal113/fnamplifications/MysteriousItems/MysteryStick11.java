...
public class MysteryStick11 extends SlimefunItem {
        ...
        if(player.getLevel() >= 25)  {
            ...
            if(event.getEntity() instanceof LivingEntity) {
                ...
                if(ThreadLocalRandom.current().nextInt(100) < 10){
                    ...
                    victim.sendMessage(ChatColor.RED + "" + ChatColor.BOLD + "危险就在你身后");
                }
            } else {
                return;
            }
    ...
    public List<String> loreUpdate(List<String> lore2, int get_Damage, int xpamount){
        lore2.add(0,ChatColor.GOLD + "危机感");
        ...
        lore2.add(5, ChatColor.BLUE +"◆ 35%几率  5s 缓慢");
        lore2.add(6, ChatColor.BLUE +"◆ 40%几率  4s 虚弱");
        lore2.add(7, ChatColor.BLUE +"◆ 30%几率  5s 饥饿");
        lore2.add(8, ChatColor.BLUE +"◆ 10%几率  tp 至敌人身后");
    ...
    public void transformWeapon(Player p, ItemStack item) {
        ...
        if (p.getLevel() <= 25) {
            ...
            lore.remove(3);
            lore.remove(3);
            lore.set(0, ChatColor.WHITE + "定海神针");
