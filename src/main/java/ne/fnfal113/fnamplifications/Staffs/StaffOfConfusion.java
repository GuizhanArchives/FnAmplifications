...
public class StaffOfConfusion extends LimitedUseItem {

    public StaffOfConfusion(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {
        super(itemGroup, item, recipeType, recipe);

        setMaxUseCount(FNAmplifications.getInstance().getConfigManager().staffOfConfusion());
    }
